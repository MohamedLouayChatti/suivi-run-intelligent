...
class TicketDetailDTO:
	...
	assignee_id: UUID; category: Category; functional_team: FunctionalTeam
	genergy_id: str | None; oceane_id: str | None; jira_id: str | None; requires_jira: bool
	operational_highlight: bool; offer: Offer | None; version: Version | None; element: Element | None
	...
	def from_ticket(cls, ticket: Ticket) -> TicketDetailDTO:
		return cls(ticket.id, ticket.title, ticket.description, ticket.application, ticket.status,
			...
			ticket.genergy_id, ticket.oceane_id, ticket.jira_id, ticket.requires_jira,
			ticket.operational_highlight, ticket.offer, ticket.version, ticket.element,
