...
class SimilarityResult:
	...
	def create(
		...
		similarity_score: float, rank: int, generated_at: datetime,
		...
		return cls(
			...
			similarity_score=similarity_score, rank=rank, generated_at=generated_at,
			embedding_model_version=embedding_model_version, algorithm_version=algorithm_version,
		)
